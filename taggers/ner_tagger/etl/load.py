...
def run(instagram  , 
    ...
    try:
        ...
        instagram_operations = [
            UpdateOne({'_id': d['_id']}, 
            {'$set': {'ner': d['ner']}}, upsert=True) for d in instagram]
    ...
    try:
        ...
        twitter_operations = [
            UpdateOne({'_id': d['_id']}, 
            {'$set': {'ner': d['ner']}}, upsert=True) for d in twitter]
    ...
    try:
        ...
        telegram_group_operations = [
            UpdateOne({'_id': d['_id']}, 
            {'$set': {'ner': d['ner']}}, upsert=True) for d in telegram_group]
    ...
    try:
        ...
        telegram_channel_operations = [
            UpdateOne({'_id': d['_id']}, 
            {'$set': {'ner': d['ner']}}, upsert=True) for d in telegram_channel]
    ...
    try:
        ...
        news_agency_operations = [
            UpdateOne({'_id': d['_id']}, 
            {'$set': {'ner': d['ner']}}, upsert=True) for d in news_agency]
